...
const Slider = () => {
  const slides = [
    ...
    },
    {
      ...
      actor: "Noah Schnapp",
      description:
        "Will Byers mysteriously vanishes. No one knows where he went, and the word around town is that he had a bike accident and unfortunately got seriously injured because of it. However, his friends refuse to believe this, and with their new friend Eleven, try to get to the bottom of this and eventually discover what is really at play. He is the son of Joyce.",
    },
  ];
  ...
  return (
    <div className="slider">
      ...
      <Thumbnail slides={slides} activeIndex={activeIndex} setActiveIndex={setActiveIndex}/>
    </div>
  );
};
